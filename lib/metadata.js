...
export function generateMetadata(page) {
  const pages = {
    ...
    yorumlar: {
      title: 'Misafir Yorumları - Serenity İskele Tatil Evi',
      description: 'Serenity İskele misafirlerinin gerçek yorumları ve değerlendirmeleri. Kuzey Kıbrıs İskele\'deki lüks villa deneyimlerini okuyun.',
      keywords: [...siteConfig.keywords, 'yorumlar', 'değerlendirmeler', 'misafir görüşleri', 'müşteri yorumları'],
      ogTitle: 'Misafir Yorumları | Serenity İskele',
      ogDescription: 'Gerçek misafir deneyimleri ve değerlendirmeleri. Neden bizi tercih ediyorlar?',
      canonical: `${siteConfig.url}/yorumlar`
    }
  }
